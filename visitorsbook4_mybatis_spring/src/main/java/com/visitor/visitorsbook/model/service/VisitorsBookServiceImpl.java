...
//	private VisitorsBookDao visitorsBookDao;
	...
	public void registerArticle(VisitorsBookDto visitorsBookDto) throws Exception {
		VisitorsBookDao visitorsBookMapper = sqlSession.getMapper(VisitorsBookDao.class);
	...
	public List<VisitorsBookDto> listArticle(Map<String, String> map) throws Exception {
		...
		return sqlSession.getMapper(VisitorsBookDao.class).listArticle(param);
	}
	...
	public PageNavigation makePageNavigation(Map<String, String> map) throws Exception {
		...
		int totalCount = sqlSession.getMapper(VisitorsBookDao.class).getTotalCount(map);
	...
	public VisitorsBookDto getArticle(int articleNo) throws Exception {
		return sqlSession.getMapper(VisitorsBookDao.class).getArticle(articleNo);
	}

	@Override
	public void updateArticle(VisitorsBookDto visitorsBookDto) throws Exception {
		sqlSession.getMapper(VisitorsBookDao.class).updateArticle(visitorsBookDto);
	}
	...
	public void deleteArticle(int articleNo, String path) throws Exception {
		VisitorsBookDao visitorsBookMapper = sqlSession.getMapper(VisitorsBookDao.class);
		List<FileInfoDto> fileList = sqlSession.getMapper(VisitorsBookDao.class).fileInfoList(articleNo);
